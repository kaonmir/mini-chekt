...
(1, 'Main Entrance Cam 1', '192.168.1.101', 'admin', 'securepass123', true, '2024-01-15 10:30:00+09'),
(1, 'Main Entrance Cam 2', '192.168.1.102', 'admin', 'securepass123', true, '2024-01-15 10:30:00+09'),
(2, 'Backup Entrance Cam', '192.168.1.201', 'admin', 'securepass123', true, '2024-01-15 10:30:00+09'),
(3, 'Harbor Dock Cam 1', '192.168.2.101', 'harbor_admin', 'harborpass456', true, '2024-01-15 09:45:00+09'),
(3, 'Harbor Dock Cam 2', '192.168.2.102', 'harbor_admin', 'harborpass456', true, '2024-01-15 09:45:00+09'),
(4, 'Harbor Storage Cam', '192.168.2.201', 'harbor_admin', 'harborpass456', false, '2024-01-15 09:45:00+09'),
(5, 'Terminal Check-in Cam', '192.168.3.101', 'airport_admin', 'airportpass789', true, '2024-01-15 07:20:00+09'),
(5, 'Terminal Security Cam', '192.168.3.102', 'airport_admin', 'airportpass789', true, '2024-01-15 07:20:00+09'),
(6, 'Terminal Gate Cam', '192.168.3.201', 'airport_admin', 'airportpass789', true, '2024-01-15 07:20:00+09'),
(7, 'Factory Floor Cam 1', '192.168.4.101', 'factory_admin', 'factorypass321', true, '2024-01-15 09:00:00+09'),
(7, 'Factory Floor Cam 2', '192.168.4.102', 'factory_admin', 'factorypass321', true, '2024-01-15 09:00:00+09'),
(8, 'Factory Warehouse Cam', '192.168.4.201', 'factory_admin', 'factorypass321', true, '2024-01-15 09:00:00+09'),
(9, 'Research Lab Cam 1', '192.168.5.101', 'research_admin', 'researchpass654', true, '2024-01-15 08:30:00+09'),
(9, 'Research Lab Cam 2', '192.168.5.102', 'research_admin', 'researchpass654', true, '2024-01-15 08:30:00+09'),
