...
type Channel struct {
	...
	// OnBroadcast is a message handler for BROADCAST event messages
...
// WithBroadcast option sets the broadcast channel for a topic.
...
func (ch *Channel) setDefaultMessageHandlers() {
	...
	if ch.OnBroadcast == nil {
		ch.OnBroadcast = func(m Message) {
